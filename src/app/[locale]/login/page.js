...
import { Shield, Eye, EyeOff, Loader2, AlertCircle, Star } from "lucide-react";
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-gray-950 flex items-center justify-center px-4 py-12">
            ...
            <div className="fixed inset-0 overflow-hidden pointer-events-none">
                ...
                <div className="absolute bottom-1/4 right-1/4 w-[300px] h-[300px] bg-teal-500/5 rounded-full blur-[100px]" />
            </div>
                ...
                <div className="bg-white dark:bg-gray-900/80 border border-gray-200 dark:border-gray-800 rounded-2xl p-8 backdrop-blur-sm shadow-xl dark:shadow-2xl">
                    <div className="text-center mb-6">
                        ...
                        <p className="text-gray-500 dark:text-gray-400 mt-1.5 text-sm">
                            Welcome back, protector. Your family is waiting.
                        </p>
                    </div>
                    ...
                    <div className="mt-6 pt-5 border-t border-gray-200 dark:border-gray-800">
                        <div className="flex items-center justify-center gap-2 mb-3">
                            <div className="flex -space-x-1.5">
                                {['bg-emerald-500', 'bg-teal-500', 'bg-cyan-500', 'bg-emerald-600'].map((bg, i) => (
                                    <div key={i} className={`w-7 h-7 ${bg} rounded-full border-2 border-white dark:border-gray-900 flex items-center justify-center text-white text-[10px] font-bold`}>
                                        {['A', 'R', 'K', 'S'][i]}
                                    </div>
                                ))}
                            </div>
                            <span className="text-xs text-gray-500 dark:text-gray-400 font-medium">
                                15,000+ parents trust us
                            </span>
                        </div>
                        <div className="flex justify-center items-center gap-1 mb-3">
                            ...
                            <span className="text-xs text-gray-500 dark:text-gray-400 font-medium ml-1">4.9/5 rating</span>
                        </div>
